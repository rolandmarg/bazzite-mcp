...
5. Search local knowledge with `docs(action="search", query=...)` and follow official source pointers when needed.
...
4. Search local knowledge or follow official source pointers for service-specific Bazzite guidance.
